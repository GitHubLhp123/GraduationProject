...
public class hiveServer {
   public BasicDataSource dataSource=null;
    ...
    public JdbcTemplate getHiveJdbcTemplate(DataQueryLogEntity dataQueryLogEntity, TeamDsEntity teamDsEntity) {
...
//    }
    ...
    public static Map<String, Object> testDsDataOfHive(TeamDsEntity teamDsEntity) {
        Map<String, Object> map = new HashMap<String, Object>();
