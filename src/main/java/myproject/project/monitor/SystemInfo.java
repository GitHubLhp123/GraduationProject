package myproject.project.monitor;
...
//        System.out.println("当前交换区剩余量:    " + swap.getFree() / 1024L + "K free");
    ...
    public static void printCpuPerc(CpuPerc cpu) {
        ...
        int cpuUser=((int)(Math.round(cpu.getUser())*100));
        ...
        int cpuSys=((int)(Math.round(cpu.getSys())*100));
        ...
        int cpuError=((int)(Math.round(cpu.getNice())*100));
